  ...
  return (
    <div className="mx-auto max-w-3xl">
      <section className="overflow-hidden rounded-[28px] border border-slate-200 bg-white shadow-sm">
        <div className="bg-slate-950 px-6 py-7 text-center text-white sm:px-8">
        ...
        <div className="px-6 py-8 sm:px-8">
          <div className="mx-auto max-w-sm rounded-[24px] border border-slate-200 bg-slate-50 p-5 text-center">
            ...
            <div className="mt-4 rounded-2xl bg-white px-4 py-3 text-left shadow-sm">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-xs font-bold uppercase tracking-wide text-slate-500">{bankName}</p>
                  <p className="font-extrabold text-slate-950">{accountName}</p>
                  <p className="text-sm font-semibold text-slate-600">{accountNumber}</p>
                </div>
              </div>
            </div>
          ...
          <div className="mt-6 grid gap-3 sm:grid-cols-2">
            <Link to="/app/contact" className="inline-flex h-12 items-center justify-center gap-2 rounded-2xl border border-slate-200 bg-white text-sm font-extrabold text-slate-800 hover:bg-slate-50">
              <Mail size={18} />
              Liên hệ admin
            </Link>
